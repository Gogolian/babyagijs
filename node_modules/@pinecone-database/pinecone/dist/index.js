...
var ErrorWithoutStackTrace = /** @class */ (function (_super) {
    __extends(ErrorWithoutStackTrace, _super);
    function ErrorWithoutStackTrace(message) {
        var _newTarget = this.constructor;
        var _this = _super.call(this, message) || this;
        _this.name = 'ErrorWithoutStackTrace';
        Object.setPrototypeOf(_this, _newTarget.prototype);
        _this.stack = '';
        return _this;
    }
    return ErrorWithoutStackTrace;
}(Error));
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    try {
                        ...
                        return [2 /*return*/, Promise.reject(new ErrorWithoutStackTrace("".concat(json === null || json === void 0 ? void 0 : json.message)))];
                    }
                    catch (e) {
                        return [2 /*return*/, Promise.reject(new ErrorWithoutStackTrace("PineconeClient: Error calling ".concat(func.name.replace("bound ", ""), ": ").concat(text)))];
                    }
                    return [3 /*break*/, 6];
                case 5: return [2 /*return*/, Promise.reject(new ErrorWithoutStackTrace("PineconeClient: Error calling ".concat(func.name.replace("bound ", ""), ": ").concat(error)))];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, process.nextTick(function () { })];
                    case 2:
                        // Workaround for Jest TLSWRAP issue
                        _a.sent();
                    ...
                    case 5:
                        error_1 = _a.sent();
                        throw new ErrorWithoutStackTrace("PineconeClient: Error getting project name: ".concat(error_1));
